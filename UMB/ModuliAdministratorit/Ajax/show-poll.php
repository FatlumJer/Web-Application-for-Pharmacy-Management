...
$ses_sql = mysqli_query($conn,"SELECT id, perdoruesi FROM umb_perdoruesit WHERE perdoruesi='$user_check' ");
...
<div class="error">Votimi perfundoi me sukses! <br>Ju lutem prisni 3 sekonda!!</div>
