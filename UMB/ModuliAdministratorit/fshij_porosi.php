...
<html>
	...
	<table>
	<tr>
	<h3>Kerko Porosi per Fshirje</h3>
	</tr>
	<tr>
...
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"FshijPorosi.php?id_porosia=$row[id_porosia]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button special' class='button primary'>Fshij</a>
		</td></tr>";		
	}
