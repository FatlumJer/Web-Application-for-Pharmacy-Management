...
<html>
	...
	<td>
	<input type="text" name="term" placeholder="Titullin ose Pamjen"/>
</td>
...
while($row = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"ModifikoTeDhenat.php?ID_Data=$row[ID_Data]\" class='button special' class='button primary'>
		Modifiko</a></td></tr>";		
	}
